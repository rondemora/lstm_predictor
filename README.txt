This repository is part of the final project 'A comparison between LSTM and Facebook Prophet models: a financial forecasting case study'.
...
The folders LSTM_FINAL_MODELS/, PROPHET_MODELS and LST_FIRST_MODELS contain both models and plots of just some of the models generated and tested for the project. The majority of them were not pushed to decrease the project's size.
